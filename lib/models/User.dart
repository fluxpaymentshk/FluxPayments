...
class User extends Model {
  ...
  const User._internal({required this.id, required firstName, lastName, dateOfBirth, idCardNumber, required uniqueID, mobileNumber, email, fluxPoints, UserToRewardTransactions, favorites, UserToServiceTransactions, hasBankAccounts, hasDebitCards, hasCreditCard, hasWallets, required refreeID, referredTo}): _firstName = firstName, _lastName = lastName, _dateOfBirth = dateOfBirth, _idCardNumber = idCardNumber, _uniqueID = uniqueID, _mobileNumber = mobileNumber, _email = email, _fluxPoints = fluxPoints, _UserToRewardTransactions = UserToRewardTransactions, _favorites = favorites, _UserToServiceTransactions = UserToServiceTransactions, _hasBankAccounts = hasBankAccounts, _hasDebitCards = hasDebitCards, _hasCreditCard = hasCreditCard, _hasWallets = hasWallets, _refreeID = refreeID, _referredTo = referredTo;
  
  factory User({String? id, required String firstName, String? lastName, TemporalDate? dateOfBirth, String? idCardNumber, required String uniqueID, String? mobileNumber, String? email, int? fluxPoints, List<RewardTransaction>? UserToRewardTransactions, List<String>? favorites, List<ServiceTransaction>? UserToServiceTransactions, List<Bank>? hasBankAccounts, List<DebitCard>? hasDebitCards, List<CreditCard>? hasCreditCard, List<UserWallet>? hasWallets, required String refreeID, List<String>? referredTo}) {
    return User._internal(
      ...
      UserToRewardTransactions: UserToRewardTransactions != null ? List<RewardTransaction>.unmodifiable(UserToRewardTransactions) : UserToRewardTransactions,
      favorites: favorites != null ? List<String>.unmodifiable(favorites) : favorites,
      UserToServiceTransactions: UserToServiceTransactions != null ? List<ServiceTransaction>.unmodifiable(UserToServiceTransactions) : UserToServiceTransactions,
      hasBankAccounts: hasBankAccounts != null ? List<Bank>.unmodifiable(hasBankAccounts) : hasBankAccounts,
      hasDebitCards: hasDebitCards != null ? List<DebitCard>.unmodifiable(hasDebitCards) : hasDebitCards,
      hasCreditCard: hasCreditCard != null ? List<CreditCard>.unmodifiable(hasCreditCard) : hasCreditCard,
      hasWallets: hasWallets != null ? List<UserWallet>.unmodifiable(hasWallets) : hasWallets,
      refreeID: refreeID,
      referredTo: referredTo != null ? List<String>.unmodifiable(referredTo) : referredTo);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is User &&
      ...
      DeepCollectionEquality().equals(_UserToRewardTransactions, other._UserToRewardTransactions) &&
      DeepCollectionEquality().equals(_favorites, other._favorites) &&
      DeepCollectionEquality().equals(_UserToServiceTransactions, other._UserToServiceTransactions) &&
      DeepCollectionEquality().equals(_hasBankAccounts, other._hasBankAccounts) &&
  ...
  String toString() {
    ...
    buffer.write("fluxPoints=" + (_fluxPoints != null ? _fluxPoints!.toString() : "null") + ", ");
    buffer.write("favorites=" + (_favorites != null ? _favorites!.toString() : "null") + ", ");
    buffer.write("refreeID=" + "$_refreeID" + ", ");
    buffer.write("referredTo=" + (_referredTo != null ? _referredTo!.toString() : "null"));
    buffer.write("}");
    
    return buffer.toString();
  }
  
  User copyWith({String? id, String? firstName, String? lastName, TemporalDate? dateOfBirth, String? idCardNumber, String? uniqueID, String? mobileNumber, String? email, int? fluxPoints, List<RewardTransaction>? UserToRewardTransactions, List<String>? favorites, List<ServiceTransaction>? UserToServiceTransactions, List<Bank>? hasBankAccounts, List<DebitCard>? hasDebitCards, List<CreditCard>? hasCreditCard, List<UserWallet>? hasWallets, String? refreeID, List<String>? referredTo}) {
    return User(
      id: id ?? this.id,
      ...
      UserToRewardTransactions: UserToRewardTransactions ?? this.UserToRewardTransactions,
      favorites: favorites ?? this.favorites,
      UserToServiceTransactions: UserToServiceTransactions ?? this.UserToServiceTransactions,
    ...
    : id = json['id'],
      ...
      _UserToServiceTransactions = json['UserToServiceTransactions'] is List
        ? (json['UserToServiceTransactions'] as List)
          .where((e) => e?['serializedData'] != null)
          .map((e) => ServiceTransaction.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
      _hasBankAccounts = json['hasBankAccounts'] is List
        ? (json['hasBankAccounts'] as List)
          .where((e) => e?['serializedData'] != null)
          .map((e) => Bank.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
      _hasDebitCards = json['hasDebitCards'] is List
        ? (json['hasDebitCards'] as List)
          .where((e) => e?['serializedData'] != null)
          .map((e) => DebitCard.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
      _hasCreditCard = json['hasCreditCard'] is List
        ? (json['hasCreditCard'] as List)
          .where((e) => e?['serializedData'] != null)
          .map((e) => CreditCard.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
      _hasWallets = json['hasWallets'] is List
        ? (json['hasWallets'] as List)
          .where((e) => e?['serializedData'] != null)
          .map((e) => UserWallet.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
