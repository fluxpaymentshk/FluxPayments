...
class RewardPartner extends Model {
  ...
  const RewardPartner._internal({required this.id, required name, image, required shortDescription, size, banner, franchises, Rewards, RewardPartnerToRewardTransactions, Advertises}): _name = name, _image = image, _shortDescription = shortDescription, _size = size, _banner = banner, _franchises = franchises, _Rewards = Rewards, _RewardPartnerToRewardTransactions = RewardPartnerToRewardTransactions, _Advertises = Advertises;
  
  factory RewardPartner({String? id, required String name, String? image, required String shortDescription, int? size, String? banner, List<Shop>? franchises, List<Reward>? Rewards, List<RewardTransaction>? RewardPartnerToRewardTransactions, List<InternalAdvertisers>? Advertises}) {
    return RewardPartner._internal(
      ...
      size: size,
      banner: banner,
      franchises: franchises != null ? List<Shop>.unmodifiable(franchises) : franchises,
      Rewards: Rewards != null ? List<Reward>.unmodifiable(Rewards) : Rewards,
      RewardPartnerToRewardTransactions: RewardPartnerToRewardTransactions != null ? List<RewardTransaction>.unmodifiable(RewardPartnerToRewardTransactions) : RewardPartnerToRewardTransactions,
      Advertises: Advertises != null ? List<InternalAdvertisers>.unmodifiable(Advertises) : Advertises);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is RewardPartner &&
      ...
      DeepCollectionEquality().equals(_RewardPartnerToRewardTransactions, other._RewardPartnerToRewardTransactions) &&
  ...
  RewardPartner copyWith({String? id, String? name, String? image, String? shortDescription, int? size, String? banner, List<Shop>? franchises, List<Reward>? Rewards, List<RewardTransaction>? RewardPartnerToRewardTransactions, List<InternalAdvertisers>? Advertises}) {
    return RewardPartner(
      ...
      RewardPartnerToRewardTransactions: RewardPartnerToRewardTransactions ?? this.RewardPartnerToRewardTransactions,
    ...
    : id = json['id'],
      ...
      _Rewards = json['Rewards'] is List
        ? (json['Rewards'] as List)
          ...
          .toList()
        : null,
      _RewardPartnerToRewardTransactions = json['RewardPartnerToRewardTransactions'] is List
      ...
      _Advertises = json['Advertises'] is List
        ? (json['Advertises'] as List)
          .where((e) => e?['serializedData'] != null)
          .map((e) => InternalAdvertisers.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null;
  ...
  static final QueryField ADVERTISES = QueryField(
    ...
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: (InternalAdvertisers).toString()));
