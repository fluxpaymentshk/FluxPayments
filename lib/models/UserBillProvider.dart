...
class UserBillProvider extends Model {
  ...
  const UserBillProvider._internal({required this.id, BillProviderToServiceTransactions, billproviderID, ProvideUserServices}): _BillProviderToServiceTransactions = BillProviderToServiceTransactions, _billproviderID = billproviderID, _ProvideUserServices = ProvideUserServices;
  
  factory UserBillProvider({String? id, List<ServiceTransaction>? BillProviderToServiceTransactions, String? billproviderID, List<UserService>? ProvideUserServices}) {
    return UserBillProvider._internal(
      id: id == null ? UUID.getUUID() : id,
      BillProviderToServiceTransactions: BillProviderToServiceTransactions != null ? List<ServiceTransaction>.unmodifiable(BillProviderToServiceTransactions) : BillProviderToServiceTransactions,
      billproviderID: billproviderID,
      ProvideUserServices: ProvideUserServices != null ? List<UserService>.unmodifiable(ProvideUserServices) : ProvideUserServices);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is UserBillProvider &&
      id == other.id &&
      DeepCollectionEquality().equals(_BillProviderToServiceTransactions, other._BillProviderToServiceTransactions) &&
      _billproviderID == other._billproviderID &&
      DeepCollectionEquality().equals(_ProvideUserServices, other._ProvideUserServices);
  }
  ...
  UserBillProvider copyWith({String? id, List<ServiceTransaction>? BillProviderToServiceTransactions, String? billproviderID, List<UserService>? ProvideUserServices}) {
    return UserBillProvider(
      id: id ?? this.id,
      BillProviderToServiceTransactions: BillProviderToServiceTransactions ?? this.BillProviderToServiceTransactions,
  ...
  UserBillProvider.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _BillProviderToServiceTransactions = json['BillProviderToServiceTransactions'] is List
      ...
      _ProvideUserServices = json['ProvideUserServices'] is List
        ? (json['ProvideUserServices'] as List)
          .where((e) => e?['serializedData'] != null)
          .map((e) => UserService.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'BillProviderToServiceTransactions': _BillProviderToServiceTransactions?.map((e) => e?.toJson())?.toList(), 'billproviderID': _billproviderID, 'ProvideUserServices': _ProvideUserServices?.map((e) => e?.toJson())?.toList()
  };
  ...
  static final QueryField PROVIDEUSERSERVICES = QueryField(
    ...
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: (UserService).toString()));
