...
class UserService extends Model {
  ...
  const UserService._internal({required this.id, accountID, dueDate, userbillproviderID, ServicetoServiceTransaction}): _accountID = accountID, _dueDate = dueDate, _userbillproviderID = userbillproviderID, _ServicetoServiceTransaction = ServicetoServiceTransaction;
  
  factory UserService({String? id, String? accountID, TemporalDate? dueDate, String? userbillproviderID, ServiceTransaction? ServicetoServiceTransaction}) {
  ...
  String toString() {
    ...
    buffer.write("ServicetoServiceTransaction=" + (_ServicetoServiceTransaction != null ? _ServicetoServiceTransaction!.toString() : "null"));
    buffer.write("}");
    
    return buffer.toString();
  }
  
  UserService copyWith({String? id, String? accountID, TemporalDate? dueDate, String? userbillproviderID, ServiceTransaction? ServicetoServiceTransaction}) {
    return UserService(
      id: id ?? this.id,
      accountID: accountID ?? this.accountID,
      dueDate: dueDate ?? this.dueDate,
      userbillproviderID: userbillproviderID ?? this.userbillproviderID,
      ServicetoServiceTransaction: ServicetoServiceTransaction ?? this.ServicetoServiceTransaction);
  }
  ...
  UserService.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _ServicetoServiceTransaction = json['ServicetoServiceTransaction']?['serializedData'] != null
        ? ServiceTransaction.fromJson(new Map<String, dynamic>.from(json['ServicetoServiceTransaction']['serializedData']))
        : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'accountID': _accountID, 'dueDate': _dueDate?.format(), 'userbillproviderID': _userbillproviderID, 'ServicetoServiceTransaction': _ServicetoServiceTransaction?.toJson()
  };
  ...
  static final QueryField USERBILLPROVIDERID = QueryField(fieldName: "userbillproviderID");
