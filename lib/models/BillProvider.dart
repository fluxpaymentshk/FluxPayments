...
class BillProvider extends Model {
  ...
  const BillProvider._internal({required this.id, name, shortDescription, logo, ProvidesUserBill, hasServices}): _name = name, _shortDescription = shortDescription, _logo = logo, _ProvidesUserBill = ProvidesUserBill, _hasServices = hasServices;
  
  factory BillProvider({String? id, String? name, String? shortDescription, String? logo, List<UserBillProvider>? ProvidesUserBill, List<Service>? hasServices}) {
    return BillProvider._internal(
      id: id == null ? UUID.getUUID() : id,
      name: name,
      shortDescription: shortDescription,
      logo: logo,
      ProvidesUserBill: ProvidesUserBill != null ? List<UserBillProvider>.unmodifiable(ProvidesUserBill) : ProvidesUserBill,
      hasServices: hasServices != null ? List<Service>.unmodifiable(hasServices) : hasServices);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is BillProvider &&
      ...
      _logo == other._logo &&
      DeepCollectionEquality().equals(_ProvidesUserBill, other._ProvidesUserBill) &&
  ...
  BillProvider copyWith({String? id, String? name, String? shortDescription, String? logo, List<UserBillProvider>? ProvidesUserBill, List<Service>? hasServices}) {
    return BillProvider(
      id: id ?? this.id,
      name: name ?? this.name,
    ...
    : id = json['id'],
      ...
      _ProvidesUserBill = json['ProvidesUserBill'] is List
        ? (json['ProvidesUserBill'] as List)
          ...
          .map((e) => UserBillProvider.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
  ...
  static final QueryField PROVIDESUSERBILL = QueryField(
    ...
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: (UserBillProvider).toString()));
