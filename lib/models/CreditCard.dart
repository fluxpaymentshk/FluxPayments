...
class CreditCard extends Model {
  ...
  const CreditCard._internal({required this.id, creditCardNumber, expiryDate, bankName, cvv, name, userID}): _creditCardNumber = creditCardNumber, _expiryDate = expiryDate, _bankName = bankName, _cvv = cvv, _name = name, _userID = userID;
  
  factory CreditCard({String? id, int? creditCardNumber, TemporalDate? expiryDate, String? bankName, int? cvv, String? name, String? userID}) {
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write("creditCardNumber=" + (_creditCardNumber != null ? _creditCardNumber!.toString() : "null") + ", ");
  ...
  CreditCard copyWith({String? id, int? creditCardNumber, TemporalDate? expiryDate, String? bankName, int? cvv, String? name, String? userID}) {
    return CreditCard(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'creditCardNumber': _creditCardNumber, 'expiryDate': _expiryDate?.format(), 'bankName': _bankName, 'cvv': _cvv, 'name': _name, 'userID': _userID
  };

  static final QueryField ID = QueryField(fieldName: "creditCard.id");
  static final QueryField CREDITCARDNUMBER = QueryField(fieldName: "creditCardNumber");
