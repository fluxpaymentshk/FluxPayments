      ...
      body: ListView(padding: EdgeInsets.all(10.0), children: <Widget>[
        ...
        Container(
            ...
            child: Column(children: <Widget>[
              ...
              ElevatedButton(
                  onPressed: _registerGlobalProperties,
                  child: const Text('Register Global Prop')),
              ElevatedButton(
                  onPressed: _unregisterGlobalProperties,
                  child: const Text('Unregister Global Prop')),
              ElevatedButton(
                  onPressed: _unregisterAllGlobalProperties,
              ...
              ElevatedButton(
                  onPressed: _identifyUser, child: const Text('Register User')),
              const Divider(
                color: Colors.black,
                height: 3,
                thickness: 1,
